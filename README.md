...
* `Select` allows by default to select just one item, and the user may enter a "q" for "quit", but both can be changed via the left argument; you may also demand a particular number of items, say exactly two
